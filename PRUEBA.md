...
## Punto 20?21 tipo rj45, cable cat5e: el puerto fisico posee dos numeros asignados, pero con las pruebas se determino que es el 20, este obtuvo un bert fail con todos los pares conectados, segun el analsis se determino que el error ocurrio por una atenuacion signifcativa lo que provoca a su vez perdida de paquetes haciendo que sea psoible una conexion, pero muy poco estable y nada recomendada, raelizando una pequeña limpieza en los puertos y verificando que todo estuviera bien en el patch panel decidimos realizar nuevmanete la prueba pero la respuesta fue la misma y concluimos que el problema estaba en una zona que no tenemos acceso. 
